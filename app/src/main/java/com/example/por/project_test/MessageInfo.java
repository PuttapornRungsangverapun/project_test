...
class MessageInfo {
    ...
    String message, filename, type, tmpLat, tmpLon, time, authen;
    int message_id, message_sender_id, message_status;
    double latitude, longtitude;

    MessageInfo(int message_id, String message, int message_status, int message_sender_id, String filename, String latitude, String longtitude, String authen, String time, String type) {
